...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="{{ route('kraftstoffart.update', $kraftstoffart) }}"
                method="POST"
                autocomplete="off">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="name"
                                    id="name"
                                    value="{{ old('name', $kraftstoffart->name) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="{{ old('sort_order', $kraftstoffart->sort_order) }}"
                                    class="form-control my-select @error('sort_order') is-invalid @enderror"
                                    min="0"
                                    step="1">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="slug"
                                    id="slug"
                                    value="{{ old('slug', $kraftstoffart->slug) }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-control custom-switch auto-switch">
                                        ...
                                        <input
                                            ...
                                            name="is_active"
                                            value="1"
                                            {{ old('is_active', $kraftstoffart->is_active) ? 'checked' : '' }}>
                                    ...
                                    <label
                                        ...
                                        {{ old('is_active', $kraftstoffart->is_active) ? 'Active' : 'Inactive' }}
