...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="<?php echo e(route('ausstattung.update', $ausstattung)); ?>"
                method="POST"
                autocomplete="off">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    class="form-control my-select <?php $__errorArgs = ['feature_category_id'];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__errorArgs = ['feature_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <small class="form-text text-muted">
                                    Select the category where this feature
                                    should be displayed.
                                </small>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="name"
                                    id="name"
                                    value="<?php echo e(old('name', $ausstattung->name)); ?>"
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="slug"
                                    id="slug"
                                    value="<?php echo e(old('slug', $ausstattung->slug)); ?>"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="<?php echo e(old('sort_order', $ausstattung->sort_order)); ?>"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <small class="form-text text-muted mt-2">
                                    Inactive features will not be available
                                    when creating or editing vehicles.
                                </small>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/projects/autohande/resources/views/backend/admin/feature/edit.blade.php ENDPATH**/ ?>