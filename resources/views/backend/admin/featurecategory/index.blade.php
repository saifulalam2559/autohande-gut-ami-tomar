...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-header">
                ...
                <a
                    href="{{ route('ausstattungcategory.create') }}"
            ...
            <div class="card-body">
                ...
                <form
                    method="GET"
                    action="{{ route('ausstattungcategory.index') }}">
                        ...
                        @forelse($categories as $category)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a
                                        href="{{ route('ausstattungcategory.edit', $category) }}"
                                    ...
                                    <form
                                        action="{{ route('ausstattungcategory.destroy', $category) }}"
                                        method="POST"
                                        class="d-inline"
    ...
    {{ $categories->appends(request()->query())->links('pagination-links') }}
