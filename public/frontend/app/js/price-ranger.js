...
$(document).ready(function () {
  if ($("#slider-range").length > 0) {
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
      ...
      document.getElementsByName('min-value')[0].value = moneyFormat.from(
        values[0]);
      document.getElementsByName('max-value')[0].value = moneyFormat.from(
        values[1]);
    });
  }
});
...
$(document).ready(function () {
  if ($("#slider-range2").length > 0) {
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
      ...
      document.getElementsByName('min-value2')[0].value = moneyFormat.from(
        values[0]);
      document.getElementsByName('max-value2')[0].value = moneyFormat.from(
        values[1]);
    });
  }
});
$(document).ready(function () {
  if ($("#slider-range3").length > 0) {
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
      ...
      document.getElementsByName('min-value3')[0].value = moneyFormat.from(
        values[0]);
      document.getElementsByName('max-value3')[0].value = moneyFormat.from(
        values[1]);
    });
  }
});
$(document).ready(function () {
  if ($("#slider-range4").length > 0) {
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
      ...
      document.getElementsByName('min-value4')[0].value = moneyFormat.from(
        values[0]);
      document.getElementsByName('max-value4')[0].value = moneyFormat.from(
        values[1]);
    });
  }
});
$(document).ready(function () {
  if ($("#slider-range5").length > 0) {
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
      ...
      document.getElementsByName('min-value5')[0].value = moneyFormat.from(
        values[0]);
      document.getElementsByName('max-value5')[0].value = moneyFormat.from(
        values[1]);
    });
  }
});
$(document).ready(function () {
  if ($("#slider-range6").length > 0) {
    ...
    rangeSlider.noUiSlider.on('update', function (values, handle) {
      ...
      document.getElementsByName('min-value6')[0].value = moneyFormat.from(
        values[0]);
      document.getElementsByName('max-value6')[0].value = moneyFormat.from(
        values[1]);
    });
  }
});
