    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-header">
                ...
                <a
                    href="{{ route('fahrzeugzustand.index') }}"
            ...
            <form
                action="{{ route('fahrzeugzustand.update', $fahrzeugzustand) }}"
                method="POST"
                autocomplete="off">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="name"
                                    id="name"
                                    value="{{ old('name', $fahrzeugzustand->name) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="{{ old('sort_order', $fahrzeugzustand->sort_order) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="slug"
                                    id="slug"
                                    value="{{ old('slug', $fahrzeugzustand->slug) }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-control custom-switch auto-switch">
                                        ...
                                        <input
                                            ...
                                            name="is_active"
                                            value="1"
                                            {{ old('is_active', $fahrzeugzustand->is_active) ? 'checked' : '' }}>
                                    ...
                                    <label
                                        ...
                                        {{ old('is_active', $fahrzeugzustand->is_active) ? 'Active' : 'Inactive' }}
