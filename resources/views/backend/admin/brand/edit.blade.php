...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="{{ route('marke.update', $marke) }}"
                method="POST"
                autocomplete="off">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="{{ old('sort_order', $marke->sort_order) }}"
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="custom-control custom-switch auto-switch">
                ...
                <input
                    ...
                    name="is_active"
                    value="1"
                    {{ old('is_active', $marke->is_active) ? 'checked' : '' }}>
            ...
            <label
                ...
                {{ old('is_active', $marke->is_active) ? 'Active' : 'Inactive' }}
            </label>
