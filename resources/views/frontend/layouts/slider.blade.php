            <div dir="ltr" class="swiper mainslider slider home6">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slider-item">
                            <div class="img-slider">
                                <img class="img-item lazyload" data-src="{{asset('frontend/assets/images/slider/slide6.jpg ') }}"
                                    src="{{asset('frontend/assets/images/slider/slide6.jpg ') }}" alt="">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slider-item">
                            <div class="img-slider">
                                <img class="img-item lazyload" data-src="{{asset('frontend/assets/images/slider/slide2.jpg ') }}"
