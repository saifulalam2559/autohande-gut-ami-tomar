...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="{{ route('ausstattungcategory.update', $ausstattungcategory) }}"
                method="POST"
                autocomplete="off">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="name"
                                    id="name"
                                    value="{{ old('name', $ausstattungcategory->name) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="{{ old('sort_order', $ausstattungcategory->sort_order) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="slug"
                                    id="slug"
                                    value="{{ old('slug', $ausstattungcategory->slug) }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-control custom-switch auto-switch">
                                        ...
                                        <input
                                            ...
                                            name="is_active"
                                            value="1"
                                            {{ old('is_active', $ausstattungcategory->is_active) ? 'checked' : '' }}>
                                    ...
                                    <label
                                        ...
                                        {{ old('is_active', $ausstattungcategory->is_active) ? 'Active' : 'Inactive' }}
