           <header class="header main-header">
                                            ...
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    <li class="dropdown2 current"><a href="#">Home</a>
                                                     ...
                                                     <li><a href="<?php echo e(route('fahrzeugliste')); ?>">Angebote</a></li>
                ...
                <div class="mobile-menu">
                    ...
                    <div class="nav-logo">
                        <a href="index.html">
                                <img class="lazyload" data-src="<?php echo e(asset('frontend/assets/images/logo/logo.png ')); ?>"
                                    src="<?php echo e(asset('frontend/assets/images/logo/logo.png ')); ?>" alt="" width="197" height="48">
            ...
            </header><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/projects/autohande/resources/views/frontend/layouts/nav.blade.php ENDPATH**/ ?>