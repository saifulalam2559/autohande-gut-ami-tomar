...
<script src="<?php echo e(asset('backend/js/pages/post-delete.js')); ?>"></script>
<script src="<?php echo e(asset('backend/js/pages/admin-menu.js')); ?>"></script>
<script src="<?php echo e(asset('backend/js/pages/all-autocomplete.js')); ?>"></script>
<script src="<?php echo e(asset('backend/js/pages/new-toggle-switch.js')); ?>"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/projects/autohande/resources/views/backend/layouts/footer.blade.php ENDPATH**/ ?>