            <div dir="ltr" class="swiper mainslider slider home6">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slider-item">
                            <div class="img-slider">
                                <img class="img-item lazyload" data-src="<?php echo e(asset('frontend/assets/images/slider/slide6.jpg ')); ?>"
                                    src="<?php echo e(asset('frontend/assets/images/slider/slide6.jpg ')); ?>" alt="">
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="content po-content-two">
                                            <div class="heading">
                                                ...
                                                <ul class="ul flex category-list-car flex-wrap">
                                                    ...
                                                    <div class="flex-three">
                                                        <div class="image">
                                                            <img class="img-item lazyload"
                                                                data-src="assets/images/author/avt-slide.png"
                                                                src="assets/images/author/avt-slide.png" alt="">
                                                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slider-item">
                            <div class="img-slider">
                                <img class="img-item lazyload" data-src="<?php echo e(asset('frontend/assets/images/slider/slide2.jpg ')); ?>"
                                    src="<?php echo e(asset('frontend/assets/images/slider/slide2.jpg ')); ?>" alt="">
                            </div>
                            <div class="container  relative">
                                <div class="row">
                                    <div class="col-lg-12">
            ...
            <?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/projects/autohande/resources/views/frontend/layouts/slider.blade.php ENDPATH**/ ?>