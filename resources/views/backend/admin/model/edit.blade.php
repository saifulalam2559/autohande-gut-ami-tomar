...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="{{ route('modell.update', $modell) }}"
                method="POST"
                autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    ...
                                    @foreach($brands as $brand)
                                        ...
                                        <option
                                            value="{{ $brand->id }}"
                                            {{ old('brand_id', $modell->brand_id) == $brand->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="{{ old('sort_order', $modell->sort_order) }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-control custom-switch auto-switch">
                                        ...
                                        <input
                                            ...
                                            name="is_active"
                                            value="1"
                                            {{ old('is_active', $modell->is_active) ? 'checked' : '' }}>
                                    ...
                                    <label
                                        ...
                                        {{ old('is_active', $modell->is_active) ? 'Active' : 'Inactive' }}
