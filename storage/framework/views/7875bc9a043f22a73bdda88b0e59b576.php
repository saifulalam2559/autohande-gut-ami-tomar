...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="<?php echo e(route('schadstoffklasse.update', $schadstoffklasse)); ?>"
                method="POST"
                autocomplete="off">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="name"
                                    id="name"
                                    value="<?php echo e(old('name', $schadstoffklasse->name)); ?>"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="sort_order"
                                    id="sort_order"
                                    value="<?php echo e(old('sort_order', $schadstoffklasse->sort_order)); ?>"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="slug"
                                    id="slug"
                                    value="<?php echo e(old('slug', $schadstoffklasse->slug)); ?>"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-control custom-switch auto-switch">
                                        ...
                                        <input
                                            ...
                                            name="is_active"
                                            value="1"
                                            <?php echo e(old('is_active', $schadstoffklasse->is_active) ? 'checked' : ''); ?>>
                                    ...
                                    <label
                                        ...
                                        <?php echo e(old('is_active', $schadstoffklasse->is_active) ? 'Active' : 'Inactive'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/projects/autohande/resources/views/backend/admin/emission/edit.blade.php ENDPATH**/ ?>