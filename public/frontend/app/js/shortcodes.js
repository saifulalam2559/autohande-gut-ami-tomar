...
; (function ($) {
    ...
    var dark_light = function () {
        if (localStorage.toggled === "dark-theme") {
            ...
            $(".main-header:not(.style2) .logo-box img").attr({ src: 'assets/images/logo/logo2.png' });
            $(".mobile-menu .nav-logo img").attr({ src: 'assets/images/logo/logo2.png' });
        } else {
            $("body").removeClass("dark-theme");
            $(".main-header:not(.style2) .logo-box img").attr({ src: 'assets/images/logo/logo.png' });
            $(".mobile-menu .nav-logo img").attr({ src: 'assets/images/logo/logo.png' });
        }
