...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form
                action="<?php echo e(route('marke.store')); ?>"
                method="POST"
                autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-0" style="margin-left:20px;margin-top:40px;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/projects/autohande/resources/views/backend/admin/brand/create.blade.php ENDPATH**/ ?>